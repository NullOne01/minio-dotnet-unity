...
namespace Minio
{
    public partial class MinioClient : IBucketOperations
    {
        ...
        public async Task<ListAllMyBucketsResult> ListBucketsAsync(
            CancellationToken cancellationToken = default)
        {
            var requestMessageBuilder = await CreateRequest(HttpMethod.Get);
            ...
            ListObjectsArgs args, CancellationToken cancellationToken)
        {
            ...
            while (isRunning)
            {
                ...
                if (args.Versions)
                {
                    var objectList = await GetObjectVersionsListAsync(goArgs, cts.Token);
        ...
        /// <exception cref="NotImplementedException">When a functionality or extension is not implemented</exception>
        /// <exception cref="BucketNotFoundException">When bucket is not found</exception>
        public async Task<Tagging> GetBucketTagsAsync(GetBucketTagsArgs args,
            CancellationToken cancellationToken = default)
        {
            args?.Validate();
            var requestMessageBuilder = await CreateRequest(args);
        ...
        /// <exception cref="NotImplementedException">When a functionality or extension is not implemented</exception>
        /// <exception cref="MalFormedXMLException">When configuration XML provided is invalid</exception>
        public async Task RemoveBucketTagsAsync(RemoveBucketTagsArgs args,
            CancellationToken cancellationToken = default)
        {
            args?.Validate();
            var requestMessageBuilder = await CreateRequest(args);
